const teamMembers = [
  {
    ...
    githubLink: 'https://github.com/alikri',
    photoURL: 'https://raw.githubusercontent.com/haslie22/kiddo-kingdom-data/data/team-members-images/1.jpeg',
  },
  {
    name: 'Liza Dondysh',
    ...
    impact: [
      ...
      'filled out the data for the project',
    ],
    githubLink: 'https://github.com/haslie22',
    photoURL: 'https://raw.githubusercontent.com/haslie22/kiddo-kingdom-data/data/team-members-images/2.jpeg',
  },
  {
    ...
    githubLink: 'https://github.com/AndrewMik',
    photoURL: 'https://raw.githubusercontent.com/haslie22/kiddo-kingdom-data/data/team-members-images/3.jpeg',
  },
];
